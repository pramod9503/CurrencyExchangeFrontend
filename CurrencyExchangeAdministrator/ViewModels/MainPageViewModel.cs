...
{
    public class MainPageViewModel : PropertyChangeNotifier, IDisposable, IMainPageViewModel
    {
        ...
        public async Task LoadCurrencies()
        {
            try
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    CurrenciesModel curModel = JsonSerializer.Deserialize<CurrenciesModel>(resp, AdministratorClient.JsonSerializerOptions)!;                    
